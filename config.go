...
// Config is for RocksDB configuration
type config struct {
...
// NewDefaultConfig create a default configuration for RocksDB.
func newDefaultConfig() *config {
	return &config{
		BlockSize:       1024 * 64,
		CacheSize:       1024 * 1024 * 1024 * 4,
		...
		TargetFileSizeBase:             1024 * 1024 * 64,
		TargetFileSizeMultiplier:       2,
		MaxBytesForLevelBase:           1024 * 1024 * 512,
